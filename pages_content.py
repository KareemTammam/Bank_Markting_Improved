...
def render_home():
    ...
    with left:
        # Opens the gradient "hero-frame" box; closed further down after the
        # badge/title/subtitle so the project name sits inside a nice frame,
        # matching the accent used across the sidebar and page headers.
