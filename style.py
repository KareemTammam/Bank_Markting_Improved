...
def inject_css(dark: bool = False):
    ...
    st.markdown(
        ...
        /* Keep the sidebar collapse/expand arrow working — it lives inside
           the header, so hiding the whole header (as an earlier version of
           this file did) also hid the only way to re-open a collapsed
           sidebar. We hide just the toolbar icons above and leave this
           control alone. */
